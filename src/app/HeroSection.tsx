                                ...
                                <div className="mt-12">
                                    <div className="max-w-7xl mx-auto">
                                        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
                                            {/* Content Left */}
                                            <div className="space-y-6 md:space-y-8 p-6 md:p-8 bg-white/80 dark:bg-gray-800/80 rounded-2xl shadow-lg backdrop-blur-sm">
                                                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">
                                                    Secure Metadata Management <br />
                                                ...
                                                <div className="space-y-4 md:space-y-6">
                                                    ...
                                                    {[
                                                        ...
                                                        <div key={index}
                                                            className="flex items-center space-x-4 bg-white/50 dark:bg-gray-700/50 p-4 rounded-lg transform hover:scale-105 transition-transform duration-300 cursor-pointer">
                                                            <svg className="h-5 w-5 md:h-6 md:w-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                                                            </svg>
                                                            <span className="text-base md:text-lg text-gray-700 dark:text-gray-200">{feature}</span>
                                                        </div>
                                                    ))}
                                                </div>
                                            </div>
                                            ...
                                            <div className="relative mt-8 md:mt-0 transform hover:-rotate-1 transition-transform duration-300">
                                                <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl blur opacity-30 group-hover:opacity-50"></div>
                                                <pre className="relative p-4 md:p-8 text-sm bg-gray-900 text-gray-100 rounded-xl shadow-2xl overflow-x-auto">
                                                    <div className="flex items-center space-x-2 mb-4">
                                                        <div className="w-3 h-3 rounded-full bg-red-500"></div>
                                                        <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                                                        <div className="w-3 h-3 rounded-full bg-green-500"></div>
                                                    </div>
                                                    <code className="font-mono text-xs md:text-sm">{codeExample}</code>
                                                </pre>
                                            </div>
                                        </div>
                                    </div>
