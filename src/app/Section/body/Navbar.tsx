  ...
  return (
    <nav className={`m-2 backdrop-blur-md bg-opacity-50 flex justify-between items-center w-[calc(100%-40px)] z-20 h-20 mx-auto px-6 py-4 fixed top-0 left-0 right-0 rounded-lg transition-all duration-300 ${
      ...
      <ul className="hidden md:flex justify-center items-center">
        {/* Add "Home" link */}
        <li className={`nav-links px-4 cursor-pointer capitalize font-medium relative group ${darkMode ? 'text-purple-200 hover:text-blue-200' : 'text-indigo-600 hover:text-purple-800'} hover:scale-105 duration-200 link-underline`}>
          <Link href="/">Home</Link>
        </li>
        ...
        >
          <Link
            href=""
            className={`nav-links px-4 cursor-pointer capitalize font-medium relative group ${darkMode ? 'text-purple-200 hover:text-blue-200' : 'text-indigo-600 hover:text-purple-800'} hover:scale-105 duration-200 link-underline`}
            onClick={(e) => {
              e.preventDefault();
          ...
          <div className={`absolute bottom-0 left-0 w-full h-1 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left ${darkMode ? 'bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600' : 'bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400'}`}></div>
          <ul className={`absolute top-full left-1/2 -translate-x-1/2 shadow-lg rounded-lg w-[480px] py-2 px-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 invisible group-hover:visible transform z-10 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
            <div className="grid grid-cols-3 gap-4">
              <li className={`py-1 rounded-md transition-colors duration-200 ease-in-out transform 
                  hover:-translate-y-1 ${darkMode ? 'hover:bg-gray-600' : 'hover:bg-gray-100'}`}>
                <Link href="/learn/basics" className={`block px-2 py-1 text-center 
                      ${darkMode ? 'text-white' : 'text-gray-800'}`}>Basics</Link>
              </li>
              <li className={`py-1 rounded-md transition-colors duration-200 ease-in-out transform 
                  hover:-translate-y-1 ${darkMode ? 'hover:bg-gray-600' : 'hover:bg-gray-100'}`}>
                <Link href="/learn/advanced" className={`block px-2 py-1 text-center 
                      ${darkMode ? 'text-white' : 'text-gray-800'}`}>Advanced</Link>
              </li>
              <li className={`py-1 rounded-md transition-colors duration-200 ease-in-out transform 
                  hover:-translate-y-1 ${darkMode ? 'hover:bg-gray-600' : 'hover:bg-gray-100'}`}>
                <Link href="/learn/tutorials" className={`block px-2 py-1 text-center 
                      ${darkMode ? 'text-white' : 'text-gray-800'}`}>Tutorials</Link>
              </li>
            </div>
          </ul>
        </li>
          ...
          <ul className={`absolute top-full left-1/2 -translate-x-1/2 shadow-lg rounded-lg w-[480px] py-2 px-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 invisible group-hover:visible transform z-10 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
            <div className="grid grid-cols-3 gap-4">
              <li className={`py-1 rounded-md transition-colors duration-200 ease-in-out transform 
                  hover:-translate-y-1 ${darkMode ? 'hover:bg-gray-600' : 'hover:bg-gray-100'}`}>
                <Link href="/learn/basics" className={`block px-2 py-1 text-center 
                      ${darkMode ? 'text-white' : 'text-gray-800'}`}>Docs</Link>
              </li>
              <li className={`py-1 rounded-md transition-colors duration-200 ease-in-out transform 
                  hover:-translate-y-1 ${darkMode ? 'hover:bg-gray-600' : 'hover:bg-gray-100'}`}>
                <Link href="/learn/advanced" className={`block px-2 py-1 text-center 
                      ${darkMode ? 'text-white' : 'text-gray-800'}`}>Tools</Link>
              </li>
              <li className={`py-1 rounded-md transition-colors duration-200 ease-in-out transform 
                  hover:-translate-y-1 ${darkMode ? 'hover:bg-gray-600' : 'hover:bg-gray-100'}`}>
                <Link href="/learn/tutorials" className={`block px-2 py-1 text-center 
                      ${darkMode ? 'text-white' : 'text-gray-800'}`}>Resources</Link>
              </li>
            </div>
          </ul>
        </li>
        ...
        >
          <Link
            href=""
            className={`nav-links px-4 cursor-pointer capitalize font-medium ${darkMode ? 'text-purple-200 hover:text-blue-200' : 'text-indigo-600 hover:text-purple-800'} hover:scale-105 duration-200 link-underline`}
            onClick={(e) => {
              e.preventDefault();
              // Toggle dropdown on click for desktop
          ...
          <ul className={`absolute top-full left-1/2 -translate-x-1/2 shadow-lg rounded-lg w-[480px] py-2 px-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 invisible group-hover:visible transform z-10 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
            <div className="grid grid-cols-3 gap-4">
              <li className={`py-1 rounded-md transition-colors duration-200 ease-in-out transform 
                  hover:-translate-y-1 ${darkMode ? 'hover:bg-gray-600' : 'hover:bg-gray-100'}`}>
                <Link href="/learn/basics" className={`block px-2 py-1 text-center 
                      ${darkMode ? 'text-white' : 'text-gray-800'}`}>Community</Link>
              </li>
            </div>
          </ul>
      ...
      {nav && (
        <ul className={`flex flex-col justify-center items-center absolute top-0 left-0 w-full h-160 rounded-lg ${darkMode
            ? 'bg-gray-900/90 text-gray-100 border border-gray-700/80 shadow-2xl transform transition duration-500 ease-in-out translate-x-0 opacity-100'
            : 'bg-white/90 text-gray-800 border border-gray-200/80 shadow-2xl transform transition duration-500 ease-in-out -translate-x-full opacity-0'
          ...
          <li className="nav-item relative group px-4 py-6">
            ...
            {buildOpen && (
              <ul className={`absolute top-full left-0 bg-white dark:bg-gray-800 shadow-lg rounded-md py-2 px-4 w-48 transform transition duration-300 ease-in-out opacity-0 ${buildOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2'}`}>
                <li className="py-1 rounded-md transition-colors duration-200 ease-in-out transform hover:-translate-y-1 hover:bg-gray-100 dark:hover:bg-gray-700">
                  <Link href="/build/projects" className="block px-2 py-1 text-gray-800 dark:text-white">Docs</Link>
                </li>
                <li className="py-1 rounded-md transition-colors duration-200 ease-in-out transform hover:-translate-y-1 hover:bg-gray-100 dark:hover:bg-gray-700">
